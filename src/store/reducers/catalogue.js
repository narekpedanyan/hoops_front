import {BULK_EDIT, COLLECT_SELECTED_IDS, SET_PRODUCTS, SELECT_ALL_PRODUCTS, FILTER_SHOW, SET_FILTERED_ARRAY, RESET_SELECTED_IDS} from "../actions/action-types";
    ...
    switch (action.type) {
        ...
        case COLLECT_SELECTED_IDS:
            if(state.selectedIds.includes(action.payload)){
                const filteredIds = state.selectedIds.filter((value) => value !== action.payload);
                return{
                    ...state,
