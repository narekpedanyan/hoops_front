            ...
            <div className="product_mapping_block">
                ...
                <div className="hoops_map_table">
                    <table className="hoops_map_table_in_table">
                        ...
                        <tbody>
                            {
                                importFileData && importFileData.db_fields2.map((item, index) => {
                                    return (
                                        <tr key={index}>
                                            <td>
                                                <span>{item.label}</span>
                                                {item.required && <button className="hoops_map_table_required_button">Required</button>}
                                                {item.recomended && <button className="hoops_map_table_recommended_button">Recommended</button>}
                                            ...
                                            <td>
                                                <ImportedProperty propertyItem={item} propertyOptions={importFileData.csv_headers} />
                                            </td>
                                        </tr>
                                    );
                                })
